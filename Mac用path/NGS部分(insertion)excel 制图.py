...
sheet_name = 'Sel'
sample_group = '1'  # group2 中包含的值，如 '1', '2', '3'
column_to_plot = 'Ins_mutant frequency_0.6' # 要绘制的突变频率列
...
plt.gca().yaxis.set_major_formatter(plt.FuncFormatter(lambda y, _: f'{y * 100:.3f}%'))
plt.ylim(0,0.00005)
plt.tight_layout()
